...
package com.example.weather_xml.data.repositories
...
class WeatherRepository : BaseRepository<WeatherAndCityInfo>() {
    ...
    private var callbackFilterData: ResponseCallback<WeatherAndCityInfo>? = null

    override fun onResponseSuccess(resultType: WeatherAndCityInfo) {
        callbackFilterData!!.onSuccess(resultType)
        // Handle the successful response here
        println("Weather data: $resultType")
        // Update ViewModel or LiveData with the result, e.g.:
        // HomeViewModel.updateWeatherDataInHomeViewModel(resultType)
    }
